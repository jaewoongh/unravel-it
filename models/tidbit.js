module.exports = function(mongoose) {
	...
	var tidbitSchema = new mongoose.Schema({
		// _id (auto)				// Unique ID and timestamp of creation
		docId:			ObjectId,	// ID/timestamp shared with history of this tidbit
		v:				Number,		// Revision number (increment from 0)
		momId:			ObjectId,	// Mother Entry's unique ID (_id)
	...
	return {
		schema:	tidbitSchema,
		model:	mongoose.model('Tidbit', tidbitSchema)
	}
};